...
class VideoIterativeSamplerAdvanced:
    """
    ...
    def calculate_wave_values(self, frame_idx, config):
        ...
        Always assumes TriangleWaveControllerAdvanced configuration.
        """
    ...
    def save_checkpoint(self, processed_latents, frame_idx, checkpoint_dir, run_id):
        ...
        try:
            ...
            metadata = {
                ...
                "checkpoint_type": "video_iterative_sampler_advanced"
            }
    ...
    def process_video(self, model, positive, negative, latent_batch, wave_config, seed, add_noise,
        ...
        if wave_config is None:
            raise Exception("VideoIterativeSamplerAdvanced now requires a wave_config input from TriangleWaveControllerAdvanced.")
...
NODE_CLASS_MAPPINGS = {
    "VideoIterativeSamplerAdvanced": VideoIterativeSamplerAdvanced
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "VideoIterativeSamplerAdvanced": "Video Iterative Sampler (Advanced)"
}
